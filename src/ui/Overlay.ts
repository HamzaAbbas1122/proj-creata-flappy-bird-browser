  ...
  private createContainer(): HTMLElement {
    ...
    Object.assign(element.style, {
      ...
      pointerEvents: 'none', // Allow clicks to pass through to canvas if needed, 
                             // though Game.ts handles the input globally
      userSelect: 'none'
    });
  ...
  public showStart(): void {
    ...
    this.container.innerHTML = `
      ...
      ">
        ...
        <p style="font-size: 24px; font-weight: bold; margin: 0;">Press SPACE or Click to Start</p>
      </div>
    `;
  }
  ...
  public showGameOver(score: number): void {
    ...
    this.container.innerHTML = `
      ...
      ">
        ...
        <p style="font-size: 20px; margin: 0; opacity: 0.9;">Press SPACE or Click to Restart</p>
      </div>
    `;
  }
